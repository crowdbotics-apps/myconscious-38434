"""
Django settings for myconscious_38434 project.
...
ROOT_URLCONF = 'myconscious_38434.urls'
...
WSGI_APPLICATION = 'myconscious_38434.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myconscious_38434 API",
    "DESCRIPTION": "API documentation for myconscious_38434 App",
    "VERSION": "v1",
}
